...
or 
After the plugin activation, go to Appearance &gt;&gt Widgets and drag the Transport & Buisness Locator widget to the widget area.
Select locator type and border color and click the save button and visit the website.

Note : The plugin will work either as short code or as widget ,both the option will not work at a time.
